...
export default function Projects() {
    const [projects, setProjects] = useState([
        ...
        { image: weatherApp, title: 'Weather App', deployLink:'https://blackshane.github.io/weather-app/', gitLink: 'https://github.com/blackshane/weather-app', id: 7},
...
return (
    ...
    {projects.map((project) => (
      <div className="project-list" key={project.id}>
        ...
        <h3>
          GitHub Repo Link: <a href={project.gitLink}>Repo</a>
        </h3>
        <h3>
          Link to Deployed Application:
          <a href={project.deployLink}>Deployed Application</a>
        </h3>
      </div>
        ))}
    </div>
